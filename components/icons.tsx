...
export const QuizAiIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path d="M12 2a10 10 0 0 0-3.12 19.5" />
    <path d="M12 22a10 10 0 0 0 3.12-19.5" />
    <path d="M22 12a10 10 0 0 0-19.5 3.12" />
    <path d="M2 12a10 10 0 0 0 19.5-3.12" />
...
export const GeneratorLoaderIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg 
        xmlns="http://www.w3.org/2000/svg" 
        width="24" 
        height="24" 
        ...
        {...props}
    >
        <rect className="animate-pulse-bar-1" x="4" y="4" width="4" height="16" rx="2" />
        <rect className="animate-pulse-bar-2" x="10" y="4" width="4" height="16" rx="2" />
        <rect className="animate-pulse-bar-3" x="16" y="4" width="4" height="16" rx="2" />
    </svg>
);
